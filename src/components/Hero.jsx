...
const Hero = ({isMobile}) => {
  ...
  return (
    <section className='relative w-full h-screen mx-auto flex flex-col justify-center items-center'>
      ...
      {isMobile ? 
        (
          <div className=' w-[80%] flex flex-col justify-center items-center gap-4 mt-16'>
            <motion.div
            variants={fadeIn("" ,"" ,0.1, 1)}
            className=' flex justify-center items-center w-1/2 h-1/2 rounded-full mt-10'>
            ...
            text-white shadow-md shadow-primary rounded-xl mt-6 z-50'
